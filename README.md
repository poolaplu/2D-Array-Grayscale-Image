...
The 1st and 2nd screenshots of the executed program showcases 2 seperate scenarios where and input can either be manually placed by the user and can be randomly generated by the program itself provided that the user inputs the dimensions of the 2d array prior to both of the respective actions. As it can be seen from the 3rd screenshot, the runtime for the asm segment took 620ns on average and the C segment took 1116ns on average. 
